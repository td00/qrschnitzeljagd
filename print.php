...
<div id="QR" style="">
        ...
        <br /><br />
      <input class="btn btn-success" type="button" value="Print QR" onclick="printQR()">
<br /><input class="btn btn-success" type="button" value="Print QR and Text" onclick="printQRText()">
<br /><hr /><br />
